...
/**
 * Ported from React Bits (reactbits.dev) — a card whose border and outer
 * glow track the pointer, brightening whichever edge it's nearest to. The
 * upstream component is plain JS/JSX with untyped props and CSS custom
 * properties set via inline `style`; this is that same implementation typed
 * for this codebase, unchanged in behaviour.
 */
